...
class Loader(object):
    def __init__(self, data, labels=None):
        """
        A loader class designed to help provide batches one at a time in random order during training, or in the
        same order all at once when evaluating results.
    ...
    def restore_order(self, data):
        """
        Since the data is randomly shuffled at initialization, this helper can return it to its
