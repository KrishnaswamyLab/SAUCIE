...
def parse_args():
        ...
        parser.add_argument('--lambdas_entropy', type=str, default='.0001')
                        ...
                        for batch, batch_labels in loader.iter_batches('train'):
                                ...
                                if args.save_every and iteration%args.save_every==0:
                                        ...
                                        for l in args.layers_entropy:
                                                ...
                                                mutual_info_score = calculate_mutual_info(labels, clusters)
                                                print("mutual info score: {:.3f}".format(mutual_info_score))
